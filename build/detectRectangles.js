...
function detectRectangles(imageFile) {
    ...
    contours.forEach(val => {
        ...
        img.putText(i + " : " + hierarchy.x + "," + hierarchy.y + "," + hierarchy.z + "," + hierarchy.w, new cv.Point2(rect.x + 10, rect.y + 30), cv.FONT_HERSHEY_PLAIN, 2, new cv.Vec3(0, 255, 0), cv.LINE_4, 3);
...
exports.detectRectangles = detectRectangles;
//# sourceMappingURL=detectRectangles.js.map